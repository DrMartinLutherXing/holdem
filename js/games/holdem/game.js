games.holdem.game = new CT.Class({
	...
	"_setNextDealer": function() {
		this._dealer_index = this._nextActivePlayerIndex();
	},
	...
	"_rankHand": function(pid) {
		...
		g._data[pid].rank = new mgc.lib.Rank(playerCards, 5);
	},
	...
	"_stage": function() {
		...
		//stage.pot = g._pot;
		mgc.core.actor.emit(this._host.channel, "stage", stage);
	},
	"_bid": function() {
		var g = this, b =  {
			"preflop": function() {
